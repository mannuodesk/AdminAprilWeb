...
var routes = [
    { path: '', component: layout_component_1.Layout, children: [
            ...
            { path: 'profile', loadChildren: function () { return __webpack_require__.e/* System.import */(17).then(__webpack_require__.bind(null, "./src/app/profile/profile.module.ts")).then(function (mod) { return (mod.__esModule && mod.default) ? mod.default : mod; }); } },
            ...
            { path: 'generic', loadChildren: function () { return __webpack_require__.e/* System.import */(10).then(__webpack_require__.bind(null, "./src/app/generic/generic.module.ts")).then(function (mod) { return (mod.__esModule && mod.default) ? mod.default : mod; }); } },
            { path: 'buildai', loadChildren: function () { return __webpack_require__.e/* System.import */(14).then(__webpack_require__.bind(null, "./src/app/buildai/buildai.module.ts")).then(function (mod) { return (mod.__esModule && mod.default) ? mod.default : mod; }); } },
